#Completely stolen, I have no clue how this works and spent way too long trying to figure it out.
#All I could find is that there is a pattern (when using 10007 it involes 8009, 2347, -7660, 4/17th, 129, and 11 but I couldn't figure out where these values come from)
